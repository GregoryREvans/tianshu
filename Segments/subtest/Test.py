...
voice_1_timespan_list = abjad.TimespanList([
    ...
    for start_offset, stop_offset, rhythm_maker in [
        [(9, 4), (10, 4), musicmaker_three],
        [(15, 4), (18, 4), musicmaker_one],
        [(22, 4), (25, 4), musicmaker_two],
        [(27, 4), (30, 4), musicmaker_three],
        [(30, 4), (32, 4), musicmaker_three],
    ]
])
...
voice_2_timespan_list = abjad.TimespanList([
    ...
    for start_offset, stop_offset, rhythm_maker in [
        [(9, 4), (10, 4), musicmaker_one],
        [(14, 4), (18, 4), musicmaker_two],
        [(23, 4), (25, 4), musicmaker_three],
        [(27, 4), (30, 4), musicmaker_one],
        [(30, 4), (32, 4), musicmaker_one],
    ]
])
...
voice_4_timespan_list = abjad.TimespanList([
    ...
    for start_offset, stop_offset, rhythm_maker in [
        [(2, 4), (5, 4), musicmaker_one],
        [(10, 4), (11, 4), musicmaker_two],
        [(11, 4), (13, 4), musicmaker_two],
        [(16, 4), (18, 4), musicmaker_three],
        [(21, 4), (22, 4), musicmaker_one],
        [(22, 4), (25, 4), musicmaker_one],
    ]
])
...
directory = '/Users/evansdsg2/Scores/tianshu/Segments/subtest'
