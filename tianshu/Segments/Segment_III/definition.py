...
clarinet_chord_one = [0, 6, 8, 15, 8, 6]
clarinet_notes_one = [
    clarinet_chord_one[x] for x in reduceMod5(clarinet_random_walk_one)
]
...
clarinet_chord_two = [-7, 2, 8, 11, 22, 11, 8, 2,]
clarinet_notes_two = [
...
trombone_notes_two = [
    trombone_chord_two[x] for x in reduceMod7(trombone_random_walk_two)
]
...
rmaker_one = abjadext.rmakers.TaleaRhythmMaker(
    talea=abjadext.rmakers.Talea(counts=[6, 2, 4, 2, 6, 1, 12, 8, 10], denominator=16),
...
slower_rmaker_one = abjadext.rmakers.TaleaRhythmMaker(
    talea=abjadext.rmakers.Talea(counts=[6, 2, 4, 2, 6, 1, 12, 8, 10], denominator=8),
    beam_specifier=abjadext.rmakers.BeamSpecifier(
        beam_divisions_together=True, beam_rests=False
    ),
    extra_counts_per_division=[0, 1, 0, -1],
...
attachment_handler_one = AttachmentHandler(
    starting_dynamic="mp", ending_dynamic="f", hairpin_indicator="<|", articulation=""
)
...
open(f"{build_path}/Segment_III.ly", "w").writelines(score_lines[15:-1])
