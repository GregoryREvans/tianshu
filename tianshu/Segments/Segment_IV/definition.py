...
clarinet_notes_one = [
    clarinet_chord_one[x] for x in reduceMod7(clarinet_random_walk_one)
]
...
rmaker_one = abjadext.rmakers.TaleaRhythmMaker(
    talea=abjadext.rmakers.Talea(counts=[2, 3, 2, 1, 4, 3, 1, 4, 5, 1], denominator=8),
    beam_specifier=abjadext.rmakers.BeamSpecifier(
        beam_divisions_together=True, beam_rests=False
    ),
    extra_counts_per_division=[1, 1, 0, -1, 0],
    burnish_specifier=abjadext.rmakers.BurnishSpecifier(
        left_classes=[abjad.Note, abjad.Rest], left_counts=[0, 1, 1]
    ),
...
rmaker_two = abjadext.rmakers.TaleaRhythmMaker(
    talea=abjadext.rmakers.Talea(counts=[2, 1, 3, 1, 4, 1, 1, 5], denominator=16),
    beam_specifier=abjadext.rmakers.BeamSpecifier(
        beam_divisions_together=True, beam_rests=False
    ),
...
rmaker_three = abjadext.rmakers.TaleaRhythmMaker(
    talea=abjadext.rmakers.Talea(counts=[1, 2, 1, 3, 1, 4, 5, 1, 1], denominator=16),
    beam_specifier=abjadext.rmakers.BeamSpecifier(
        beam_divisions_together=True, beam_rests=False
    ),
    extra_counts_per_division=[0, 1, 0, -1],
...
slower_rmaker_two = abjadext.rmakers.TaleaRhythmMaker(
    talea=abjadext.rmakers.Talea(counts=[2, 1, 3, 1, 4, 1, 1, 5], denominator=8),
    beam_specifier=abjadext.rmakers.BeamSpecifier(
        beam_divisions_together=True, beam_rests=False
    ),
    extra_counts_per_division=[0, 1, 0, -1],
...
slower_rmaker_three = abjadext.rmakers.TaleaRhythmMaker(
    talea=abjadext.rmakers.Talea(counts=[1, 2, 1, 3, 1, 4, 5, 1, 1], denominator=8),
    beam_specifier=abjadext.rmakers.BeamSpecifier(
        beam_divisions_together=True, beam_rests=False
    ),
    extra_counts_per_division=[0, 1, 0, -1],
...
attachment_handler_one = AttachmentHandler(
    starting_dynamic="mf", ending_dynamic="ff", hairpin_indicator="<", articulation=""
)

attachment_handler_two = AttachmentHandler(
    starting_dynamic="ff", ending_dynamic="mf", hairpin_indicator=">", articulation=""
)
